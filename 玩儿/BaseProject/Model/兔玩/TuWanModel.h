...
#import "BaseModel.h"
@class TuWanDataModel,TuWanDataIndexpicModel,TuWanDataIndexpicInfochildModel,TuWanDataIndexpicShowitemModel,TuWanDataIndexpicShowTimeInfoModel;
...
@property (nonatomic, strong) TuWanDataIndexpicShowTimeInfoModel *info;
@end


@interface TuWanDataIndexpicShowTimeInfoModel : NSObject
